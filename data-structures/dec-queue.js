class DecQueue extends DoublyLinkedList {
	...
	removeFirst() {
		if (this.size === 0) {
			throw new Error("Operation removeFirst is not supported in Empty structure.");
		}
	...
	removeLast() {
		if (this.size === 0) {
			throw new Error("Operation removeLast is not supported in Empty structure.");
		}
	...
	peekLast() {
		if (this.size === 0) {
			throw new Error("Operation peekLast is not supported in Empty structure.");
		}
